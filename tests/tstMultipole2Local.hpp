...
void testMultipole2Local(bool balanced)
{
    ...
    ASSERT_EQ(tree->numLayers(), 3) << "testUpwardsAggregation: Error: Tree depth must be depth 3.\n";

    // Get cell information for later 3.
    auto domains_host = tree->layer(0)->domains();
